...
export default function EntryPage() {
  ...
  async function handleSubmit(e: React.FormEvent) {
    ...
    setState("submitting");
    try {
      const hpField = (document.getElementById("_hp_entry") as HTMLInputElement)?.value;
      ...
      <div className="max-w-md w-full bg-white dark:bg-gray-800 rounded-2xl shadow-xl p-8 transition-colors">
        ...
        <form onSubmit={handleSubmit} className="space-y-5">
          <div aria-hidden="true" style={{ position: "absolute", left: "-9999px", top: "-9999px" }}>
            <label htmlFor="_hp_entry">Leave blank</label>
            <input id="_hp_entry" name="_hp_entry" type="text" tabIndex={-1} autoComplete="off" />
          </div>

          <div>
            <label htmlFor="entry-name" className="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1.5">
          ...
          <div>
            <label htmlFor="entry-phone" className="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1.5">
